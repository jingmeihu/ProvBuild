...
def write_result(data1, data2, data3, data4):
    fileresult = open("result.txt", "w")
    fileresult.write(str(data1)+'\n')
    fileresult.write(str(data2)+'\n')
    fileresult.write(str(data3)+'\n')
    fileresult.write(str(data4)+'\n')
...
def write_accuracy(data1, data2):
...
write_result(Train_pt, Train_ptw, Train_ptpw, Train_ptnw)
...
write_accuracy(accuracyA, accuracyB)
