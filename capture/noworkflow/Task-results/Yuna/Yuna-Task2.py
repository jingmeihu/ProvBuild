...
data_double = double(add(data_a2, data_b2))
...
t = get_data(data_add)
p = get_data(data_double)[0:5] + get_data(data_double)[0:5] + get_data(data_double)[5:10] + get_data(data_double)[5:10]

output_write(t, p, (54, -701, 30))
